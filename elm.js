...
var _meilab$example$Main$imgUrls = {
	ctor: '::',
	_0: 'https://source.unsplash.com/3Z70SDuYs5g/800x600',
	_1: {
		ctor: '::',
		_0: 'https://source.unsplash.com/01vFmYAOqQ0/800x600',
		_1: {
			ctor: '::',
			_0: 'https://source.unsplash.com/2Bjq3A7rGn4/800x600',
			_1: {
				ctor: '::',
				_0: 'https://source.unsplash.com/t20pc32VbrU/800x600',
				_1: {ctor: '[]'}
			}
		}
	}
};
var _meilab$example$Main$itemDecoder = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'id',
	...
	_elm_lang$core$Json_Decode$string);
var _meilab$example$Main$randomPicDecoder = _elm_lang$core$Json_Decode$list(_meilab$example$Main$itemDecoder);
var _meilab$example$Main$picsDecoder = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'results',
	...
	_elm_lang$core$Json_Decode$list(_meilab$example$Main$itemDecoder));
var _meilab$example$Main$client_id = '430384107c5613959082cc50ae297ef99801bfe565cfc399d5d0ab743fa1fb81';
var _meilab$example$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _meilab$example$Main$initModel = {
	selectedImg: 'https://source.unsplash.com/3Z70SDuYs5g/800x600',
	topic: 'cat',
	urls: {ctor: '[]'}
};
var _meilab$example$Main$Model = F3(
	function (a, b, c) {
		return {selectedImg: a, topic: b, urls: c};
	});
var _meilab$example$Main$NewPics = function (a) {
	return {ctor: 'NewPics', _0: a};
};
var _meilab$example$Main$getPictureCmd = function (topic) {
	var url = A2(
		_elm_lang$core$Basics_ops['++'],
		...
		A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				topic,
				A2(_elm_lang$core$Basics_ops['++'], '&client_id=', _meilab$example$Main$client_id))));
	return A2(
		_elm_lang$http$Http$send,
		_meilab$example$Main$NewPics,
		A2(_elm_lang$http$Http$get, url, _meilab$example$Main$picsDecoder));
};
var _meilab$example$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'NoOp':
			...
			case 'GetPics':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _meilab$example$Main$getPictureCmd(model.topic)
				};
			default:
				if (_p0._0.ctor === 'Err') {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					...
					var urls = A2(
						...
						function (id) {
							return A2(
								...
								A2(_elm_lang$core$Basics_ops['++'], id, '/800x600'));
						},
						_p0._0._0);
					return {
						ctor: '_Tuple2',
...
var _meilab$example$Main$getRandomPicCmd = function () {
	var url = A2(
		_elm_lang$core$Basics_ops['++'],
	...
	return A2(
		_elm_lang$http$Http$send,
		_meilab$example$Main$NewPics,
		A2(_elm_lang$http$Http$get, url, _meilab$example$Main$randomPicDecoder));
}();
var _meilab$example$Main$init = {ctor: '_Tuple2', _0: _meilab$example$Main$initModel, _1: _meilab$example$Main$getRandomPicCmd};
var _meilab$example$Main$GetPics = {ctor: 'GetPics'};
var _meilab$example$Main$TopicChange = function (a) {
	return {ctor: 'TopicChange', _0: a};
};
var _meilab$example$Main$topicSelector = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('topic-selector'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('主题'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onInput(_meilab$example$Main$TopicChange),
					_1: {ctor: '[]'}
				},
				{ctor: '[]'}),
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_meilab$example$Main$GetPics),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('搜索'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _meilab$example$Main$SelectImg = function (a) {
	return {ctor: 'SelectImg', _0: a};
};
var _meilab$example$Main$renderImg = function (url) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
				...
				_elm_lang$html$Html$img,
				{
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Events$onClick(
							_meilab$example$Main$SelectImg(url)),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'}),
...
var _meilab$example$Main$renderSelectedImg = function (url) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('selected-img'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _meilab$example$Main$renderImg(url),
			_1: {ctor: '[]'}
		});
};
var _meilab$example$Main$renderThumbnail = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		A2(_elm_lang$core$List$map, _meilab$example$Main$renderImg, model.urls));
};
var _meilab$example$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_1: {
				ctor: '::',
				_0: _meilab$example$Main$topicSelector,
				_1: {
					ctor: '::',
					_0: _meilab$example$Main$renderSelectedImg(model.selectedImg),
					_1: {
						ctor: '::',
						_0: _meilab$example$Main$renderThumbnail(model),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _meilab$example$Main$main = _elm_lang$html$Html$program(
	{init: _meilab$example$Main$init, update: _meilab$example$Main$update, view: _meilab$example$Main$view, subscriptions: _meilab$example$Main$subscriptions})();
var _meilab$example$Main$NoOp = {ctor: 'NoOp'};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _meilab$example$Main$main !== 'undefined') {
    _meilab$example$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Main.Msg":{"args":[],"tags":{"GetPics":[],"TopicChange":["String"],"NewPics":["Result.Result Http.Error (List String)"],"SelectImg":["String"],"NoOp":[]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
